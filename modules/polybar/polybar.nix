    ...
    services.polybar = { 
      ...
      config = {
        ...
        "module/filesystem" = {
          ...
          label-mounted-background = shade4;
          label-mounted-padding = 2;
          label-unmounted-padding = 2;
          label-unmounted-background = shade4;
          label-mounted-foreground = fg;
          label-unmounted-foreground = fg;
        };
